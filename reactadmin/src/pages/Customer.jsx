...
const Customer = () => {
    ...
    return (
        <div className="admin-page mt-4">
            ...
            <p className="admin-page-subtitle">Manage customer profiles and account records.</p>
                ...
                <div className="card-body">
                    ...
                    <form onSubmit={addItem} className="row g-3 admin-form">
                        ...
                        <div className="col-12">
                            <button type="submit" className="btn btn-success admin-action-btn">Add Customer</button>
                        </div>
                    </form>
                </div>
            </div>
